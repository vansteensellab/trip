#!/usr/bin/perl;
#Edited by Ruben Schep on 20/06/2017

use strict;
use warnings;
use Data::Dumper;
use List::Util qw(sum);
use lib '/home/NFS/users/r.schep/usr/bin/perl5/lib/perl5/x86_64-linux-gnu-thread-multi/';
...
my $ind_len = 10;  # length of index [should be 0 in your case]
my $bc_len = 16;
my $pat1 = "GTCACAAGGGCCGGCCACAA"; # put the first constant sequence here from the start of the read untill the barcode
my $pat2 = "TGATCGGT";    # the first 8 nucleotides of the constant
my $kind = "exp";


my $crispr_target = "GCCGATGGTGAAGTGGTAAG";  #gRNA sequence
my $ds_target_1 = "GATTATG";    # a  small piece of sequence downstream of the cut site
my $gap_1 = 94;    # gap between $pat2 and $ds_target_1
my $gap_2 = 88;   # gap between $pat2 and $ds_target_2
my $ds_target_2 = "CACTTT";
