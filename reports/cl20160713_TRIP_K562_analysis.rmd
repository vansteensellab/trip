...
plot_2vs9 <- function(xy_table, xlab, ylab, mem_day, y_lim = ylim(-7.5,2.5), x_lim=xlim(-10,2), nCol=NULL, label_size=20, text_size=10){
...
for (poi in c('KRAB', 'G9a', 'CBX')){
	for (class in c('lad_state', 'chrom_state', 'rep_class', 'rep_family','cpg_distance')){
		...
		fc_9 = filter_data(fc_table, class,  condition_9, poi, days[poi], xtype, 'log2')
		xy_table_9 = fc_9[[1]]
