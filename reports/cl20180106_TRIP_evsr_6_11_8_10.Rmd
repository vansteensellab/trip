...
file_list = list.files('../cl20180102_TRIP_K562_evsr/cDNA', pattern='normalized',
                       full.names=T)
...
class_vec = c('6'='repressed', '8'='escaper', '11'='repressed',
              '10'='repressed', 'hPGK'='iLAD')
...
```{r}
rev_file_list = list.files('../../trip/cl20180102_TRIP_K562_evsr/mapping',
