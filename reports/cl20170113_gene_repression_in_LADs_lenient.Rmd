...
pdf('dam_profiles.pdf')
for (dam in c('K562.lamina', 'K562.nucleolus', 'K562.centromere', 'K562.speckles', 'K562.pores')){
    plot_list = list()
    for (i in names(COL_class)){
        ...
        w<-oENST %in% s #which rows in oENST correspond to genes in s
        subPOS<-oPOS[w]
        subDamFus <-damid[w, dam]
        subDamCtrl <-damid[w, paste0(dam, '.Dam')]
        o<-order(subPOS) #need to order all values by distance to gene start for running median plot:
        subPOS<-subPOS[o]
        ...
        plot_list[[i]] = ggplot(data.frame(subPOS, run_log2), aes(x=subPOS, y=run_log2)) + 
                             ...
                             ylab("log2(DAM-fussion / DAM-only)") +
                             ylim(-3,6)
...
p_expressed = this_p[which(this_p$class %in% c('not_repressed', 'iLAD')),]
s_not_repressed = which(p_expressed$class=='not_repressed')
...
norm_grocap = c(s_not_repressed, s_ilad)
...
par(mfrow=c(1,4))
sample_n = table(this_p[,'class'])['not_repressed']
...
s_not_repressed = which(this_p$class=='not_repressed')
...
p_expressed = which(this_p$class %in% c('not_repressed', 'iLAD'))
s_not_repressed = which(this_p[p_expressed, 'class']=='not_repressed')
...
norm_grocap = c(rownames(this_p[p_expressed,])[s_not_repressed],
...
pdf('proseq_all_classes.pdf', width=8, height=6)
this_p = P[which(P$name%in%rownames(plus_matrix)), ]
sample_n = table(this_p[,'class'])['not_repressed']
plot_list = list()
for(i in c('iLAD', 'not_repressed', 'repressed', 'inactive')) #for the three gene classes
   {
    ...
    plus = rbind(plus_matrix[s[which(strand=='+' & !is.na(s))], ],
                 minus_matrix[s[which(strand=='-' & !is.na(s))], 44002:1] * -1)
    mean_list = lapply(seq(1,43901,200), function(x){
                           c(x+100, sum(plus[,x:(x+200)])/length(s)/200)
                       })
    mean = do.call(rbind.data.frame, mean_list)
    colnames(mean) = c('x', 'y')
    #plot:
    ...
    # plot(mean[,1]-F_window, mean[,2], col=COL_class[i], lwd=2, type='l', xlim=c(-F_window,F_window)*0.9,ylim=c(0,5),
    #      main=paste(i, length(s)), xlab="position relative to gene start (bp)", ylab="PROseq average signal")
    # abline(v=0, lty="dotted")
}
do.call(grid.arrange, c(plot_list, nrow=1))
dev.off()
...
p_expressed = this_p[which(this_p$class %in% c('not_repressed', 'iLAD') &
                           this_p$name %in% rownames(plus_matrix)), ]
s_not_repressed = which(p_expressed$class=='not_repressed')
...
norm_proseq = c(rownames(p_expressed)[s_not_repressed],
...
for(i in c('iLAD', 'not_repressed')) #for the three gene classes
   {s = s_list[[i]]
    strand = p_expressed[s, 'strand']
    s = p_expressed[s,'name']
    s = s[which(s%in%rownames(plus_matrix))]
    plus = rbind(plus_matrix[s[which(strand=='+')], ],
                 minus_matrix[s[which(strand=='-')], 44002:1] * -1)
    mean_list = lapply(seq(1,43901,200), function(x){
                           c(x+100, sum(plus[,x:(x+200)])/length(s)/200)
                       })
    mean = do.call(rbind.data.frame, mean_list)
...
```{r, fig.width=10, fig.height=10}
load('../raw_data/prom_window_ttseq.rda')

par(mfrow=c(1,4))
this_p = P[which(P$name%in%rownames(rep1_plus_matrix)), ]
sample_n = table(this_p[,'class'])['not_repressed']
pdf('ttseq_all_.pdf', width=11, height=8)
plot_list = list()
for(i in c('iLAD', 'not_repressed', 'repressed', 'inactive')) #for the three gene classes
   {
    s = which(this_p[, 'class']==i)
...
do.call(grid.arrange, c(plot_list, nrow=1))
dev.off()
p_matched = this_p[this_p$class%in%c('not_repressed', 'iLAD'), ]
...
s_not_repressed = which(p_matched$class=='not_repressed')
tt_order = order(p_matched$tss_ttseq)
tt_not_repressed = which(tt_order %in% s_not_repressed)

tt_ilad = tt_order[c(tt_not_repressed + 1, tt_not_repressed - 1)]
...
pol_not_repressed = which(pol_order %in% s_not_repressed)

pol_ilad = pol_order[c(pol_not_repressed + 1, pol_not_repressed - 1)]
...
bwtool ex -tabs bed raw_data/prom_window_head.bed ~/data/tracks/hg19/GSM1480327_K562_PROseq_plus.bw raw_data/prom_window_head_proseq_plus.txt &
...
awk '{
    ...
    print start iLine;
    print start valLine
}' raw_data/prom_window_head_proseq_plus.txt | gzip -c > raw_data/prom_window_head_proseq_plus_sparse.txt.gz
awk '{
    start=$1"\t"$2"\t"$4"\t";
    valLine="";
    iLine="";
    ...
    print start iLine;
    print start valLine
}' raw_data/prom_window_head_proseq_plus2.txt | gzip -c > raw_data/prom_window_head_proseq_plus_sparse2.txt.gz
...
bwtool ex -tabs bed raw_data/3prime_window.bed ~/data/tracks/hg19/GSM1480327_K562_PROseq_plus.bw raw_data/3prime_proseq_plus.txt &
bwtool ex -tabs bed raw_data/3prime_window.bed ~/data/tracks/hg19/GSM1480327_K562_PROseq_minus.bw raw_data/3prime_proseq_minus.txt &
...
awk '{
    ...
    print start iLine;
    print start valLine
}' raw_data/3prime_proseq_plus.txt | gzip -c > raw_data/3prime_proseq_plus_sparse.txt.gz
...
awk '{
    ...
    print start iLine;
    print start valLine
}' raw_data/3prime_proseq_minus.txt | gzip -c > raw_data/3prime_proseq_minus_sparse.txt.gz &
...
i_list = lapply(seq(2, length(window_proseq_plus_split), 2),
                function(x, split){
                    if (length(split[[x]]) > 3){
                        return(rep(x/2, length(split[[x]][4:length(split[[x]])])))
                    }
                }, split=window_proseq_plus_split)
j_list = lapply(seq(1, length(window_proseq_plus_split), 2),
                function(x, split){
                    if (length(split[[x]]) > 3){
...
val_vec = unlist(val_list)
plus_matrix = sparseMatrix(i=i_vec, j=j_vec + 1, x=val_vec)

name_list = lapply(seq(1, length(window_proseq_plus_split), 2),
                       function(x, split){
                           split[[x]][3]
                       }, split=window_proseq_plus_split)
name_vec = unlist(name_list)

window_proseq_minus = readLines('../raw_data/prom_window_proseq_minus_sparse.txt.gz')
window_proseq_minus_split = strsplit(window_proseq_minus, '\t')

i_list = lapply(seq(2, length(window_proseq_minus_split), 2),
                function(x, split){
                    if (length(split[[x]]) > 3){
...
j_list = lapply(seq(1, length(window_proseq_minus_split), 2),
                function(x, split){
                    if (length(split[[x]]) > 3){
...
val_vec = unlist(val_list)
minus_matrix = sparseMatrix(i=i_vec, j=j_vec + 1, x=val_vec)
rownames(minus_matrix) = rownames(plus_matrix) = name_vec[!is.na(name_vec)]
save(minus_matrix, plus_matrix, file='../raw_data/prom_window_proseq.rdata')
```
...
window_proseq_plus = readLines('../raw_data/3prime_proseq_plus_sparse.txt.gz')
window_proseq_plus_split = strsplit(window_proseq_plus, '\t')
i_list = lapply(seq(2, length(window_proseq_plus_split), 2),
                function(x, split){
                    if (length(split[[x]]) > 3){
...
val_vec = unlist(val_list)
plus_matrix_3prime = sparseMatrix(i=i_vec, j=j_vec + 1, x=val_vec)
...
window_proseq_minus = readLines('../raw_data/3prime_proseq_minus_sparse.txt.gz')
window_proseq_minus_split = strsplit(window_proseq_minus, '\t')
...
val_vec = unlist(val_list)
minus_matrix_3prime = sparseMatrix(i=i_vec, j=j_vec + 1, x=val_vec)
rownames(minus_matrix_3prime) = rownames(plus_matrix_3prime) = name_vec[!is.na(name_vec)]
save(minus_matrix_3prime, plus_matrix_3prime, file='../raw_data/3prime_proseq.rdata')
```
...
```
nice -19 bwtool matrix -keep-bed -tiled-averages=100 22000:22000 raw_data/prom_window.bed ../../data/tracks/hg19/GSE75792_ttseq_rep1_plus.bw /dev/stdout | awk '{
    start=$1"\t"$2"\t"$4"\t";
    valLine="";
    iLine="";
    for(i=7;i<=NF;i++){
    ...
    print start iLine;
    print start valLine
}' | gzip -c > raw_data/prom_window_ttseq_rep1_plus_sparse.txt.gz &

nice -19 bwtool matrix -keep-bed -tiled-averages=100 22000:22000 raw_data/prom_window.bed ../../data/tracks/hg19/GSE75792_ttseq_rep1_minus.bw /dev/stdout | awk '{
    start=$1"\t"$2"\t"$4"\t";
    valLine="";
    iLine="";
    for(i=7;i<=NF;i++){
    ...
    print start iLine;
    print start valLine
}' | gzip -c > raw_data/prom_window_ttseq_rep1_minus_sparse.txt.gz &

nice -19 bwtool matrix -keep-bed -tiled-averages=100 22000:22000 raw_data/prom_window.bed ../../data/tracks/hg19/GSE75792_ttseq_rep2_plus.bw /dev/stdout | awk '{
    start=$1"\t"$2"\t"$4"\t";
    valLine="";
    iLine="";
    for(i=7;i<=NF;i++){
    ...
    print start iLine;
    print start valLine
}' | gzip -c > raw_data/prom_window_ttseq_rep2_plus_sparse.txt.gz &

nice -19 bwtool matrix -keep-bed -tiled-averages=100 22000:22000 raw_data/prom_window.bed ../../data/tracks/hg19/GSE75792_ttseq_rep2_minus.bw /dev/stdout | awk '{
    start=$1"\t"$2"\t"$4"\t";
    valLine="";
    iLine="";
    for(i=7;i<=NF;i++){
    ...
    print start iLine;
    print start valLine
}' | gzip -c > raw_data/prom_window_ttseq_rep2_minus_sparse.txt.gz &


nice -19 bwtool ex -tabs bed raw_data/prom_window.bed ../../data/tracks/hg19/GSE75792_ttseq_rep1_plus.bw raw_data/prom_window_ttseq_rep1_plus.txt &
nice -19 bwtool ex -tabs bed raw_data/prom_window.bed ../../data/tracks/hg19/GSE75792_ttseq_rep1_minus.bw raw_data/prom_window_ttseq_rep1_minus.txt &
nice -19 bwtool ex -tabs bed raw_data/prom_window.bed ../../data/tracks/hg19/GSE75792_ttseq_rep2_plus.bw raw_data/prom_window_ttseq_rep2_plus.txt &
nice -19 bwtool ex -tabs bed raw_data/prom_window.bed ../../data/tracks/hg19/GSE75792_ttseq_rep2_minus.bw raw_data/prom_window_ttseq_rep2_minus.txt &
...
awk '{
    ...
    print start iLine;
    print start valLine
}' raw_data/prom_window_ttseq_rep1_plus.txt | gzip -c > raw_data/prom_window_ttseq_rep1_plus_sparse.txt.gz &
...
awk '{
    ...
    print start iLine;
    print start valLine
}' raw_data/prom_window_ttseq_rep1_minus.txt | gzip -c > raw_data/prom_window_ttseq_rep1_minus_sparse.txt.gz &
...
awk '{
    ...
    print start iLine;
    print start valLine
}' raw_data/prom_window_ttseq_rep2_plus.txt | gzip -c > raw_data/prom_window_ttseq_rep2_plus_sparse.txt.gz &
...
awk '{
    ...
    print start iLine;
    print start valLine
}' raw_data/prom_window_ttseq_rep2_minus.txt | gzip -c > raw_data/prom_window_ttseq_rep2_minus_sparse.txt.gz &

rm raw_data/prom_window_ttseq_rep1_plus.txt raw_data/prom_window_ttseq_rep1_minus.txt \
   raw_data/prom_window_ttseq_rep2_plus.txt raw_data/prom_window_ttseq_rep2_minus.txt

nice -19 bwtool ex -tabs bed raw_data/3prime_window.bed ../../data/tracks/hg19/GSE75792_ttseq_rep1_plus.bw raw_data/3prime_ttseq_rep1_plus.txt &
nice -19 bwtool ex -tabs bed raw_data/3prime_window.bed ../../data/tracks/hg19/GSE75792_ttseq_rep1_minus.bw raw_data/3prime_ttseq_rep1_minus.txt &
nice -19 bwtool ex -tabs bed raw_data/3prime_window.bed ../../data/tracks/hg19/GSE75792_ttseq_rep2_plus.bw raw_data/3prime_ttseq_rep2_plus.txt &
nice -19 bwtool ex -tabs bed raw_data/3prime_window.bed ../../data/tracks/hg19/GSE75792_ttseq_rep2_minus.bw raw_data/3prime_ttseq_rep2_minus.txt &
...
awk '{
    ...
    print start iLine;
    print start valLine
}' raw_data/3prime_ttseq_rep1_plus.txt | gzip -c > raw_data/3prime_ttseq_rep1_plus_sparse.txt.gz &
...
awk '{
    ...
    print start iLine;
    print start valLine
}' raw_data/3prime_ttseq_rep1_minus.txt | gzip -c > raw_data/3prime_ttseq_rep1_minus_sparse.txt.gz &
...
awk '{
    ...
    print start iLine;
    print start valLine
}' raw_data/3prime_ttseq_rep2_plus.txt | gzip -c > raw_data/3prime_ttseq_rep2_plus_sparse.txt.gz &
...
awk '{
    ...
    print start iLine;
    print start valLine
}' raw_data/3prime_ttseq_rep2_minus.txt | gzip -c > raw_data/3prime_ttseq_rep2_minus_sparse.txt.gz &

rm raw_data/3prime_ttseq_rep1_plus.txt raw_data/3prime_ttseq_rep1_minus.txt \
   raw_data/3prime_ttseq_rep2_plus.txt raw_data/3prime_ttseq_rep2_minus.txt
...
val_vec = unlist(val_list)
h3k9_matrix = sparseMatrix(i=i_vec, j=j_vec + 1, x=val_vec)
...
pdf('h3k9_all_classes.pdf', width=8, height=6)
...
bedtools getfasta -name -tab -fi ~/data/hg19/genome.fa -bed raw_data/prom_window.bed -fo /dev/stdout | awk '{
    ...
    i_line=""
    j=0
    while ((k=index(tolower(line), "cg"))> 0){
        i_line = i_line"\t"k + j
        j += k
...
norm_grocap_active = c(rownames(P[p_expressed,])[s_not_repressed],
...
```{r}
cpg_window = readLines('../raw_data/cpg_window.txt.gz')
...
grid.arrange(plot_list[['iLAD']], plot_list[['not_repressed']], plot_list[['repressed']], plot_list[['inactive']], top=textGrob("ratio between cpg and\nnon-cpg promoter classes",gp=gpar(fontsize=20,font='bold')), nrow=1)
...
non_cpg_prom = tss_gr[which(tss_gr$cpg_distance >= 1000)]$name
pdf('cpg_classes_stringent.pdf', width=10)
...
load('../raw_data/prom_window_proseq.rdata')
pdf('proseq_all_classes_3prime.pdf', width=8, height=6)
this_p = P[which(P$name%in%rownames(plus_matrix_3prime)), ]
sample_n = table(this_p[,'class'])['not_repressed']
plot_list = list()
for(i in c('iLAD', 'not_repressed', 'repressed', 'inactive')) #for the three gene classes
   {
    ...
    plus = rbind(plus_matrix_3prime[s[which(strand=='+' & !is.na(s))], ],
                 minus_matrix_3prime[s[which(strand=='-' & !is.na(s))], 44002:1] * -1)
    mean_list = lapply(seq(1,43901,200), function(x){
                           c(x+100, sum(plus[,x:(x+200)])/length(s)/200)
                       })
    mean = do.call(rbind.data.frame, mean_list)
...
p_expressed = this_p[which(this_p$class %in% c('not_repressed', 'iLAD') &
                           this_p$name %in% rownames(plus_matrix_3prime)), ]
s_not_repressed = which(p_expressed$class=='not_repressed')
pro_order = order(p_expressed$tssr_proseq_sense)
pro_not_repressed = which(pro_order %in% s_not_repressed)
...
for(i in c('iLAD', 'not_repressed')) #for the three gene classes
   {s = s_list[[i]]
    strand = p_expressed[s, 'strand']
    s = p_expressed[s,'name']
    s = s[which(s%in%rownames(plus_matrix_3prime))]
    plus = rbind(plus_matrix_3prime[s[which(strand=='+')], ],
                 minus_matrix_3prime[s[which(strand=='-')], 44002:1] * -1)
    mean_list = lapply(seq(1,43901,200), function(x){
                           c(x+100, sum(plus[,x:(x+200)])/length(s)/200)
                       })
    mean = do.call(rbind.data.frame, mean_list)
...
load('../raw_data/3prime_ttseq.rda')

par(mfrow=c(1,4))
this_p = P[which(P$name%in%rownames(rep1_plus_matrix_3prime)), ]
sample_n = table(this_p[,'class'])['not_repressed']
pdf('ttseq_all_3prime.pdf', width=11, height=8)
plot_list = list()
for(i in c('iLAD', 'not_repressed', 'repressed', 'inactive')) #for the three gene classes
   {
    s = which(this_p[, 'class']==i)
    ...
    strand = this_p[,'strand'][s]
    name_vec = this_p[, 'name'][s]
    s = match(name_vec, rownames(rep1_plus_matrix_3prime))
    plus1 = rbind(rep1_plus_matrix_3prime[s[which(strand=='+' & !is.na(s))], ],
                  rep1_minus_matrix_3prime[s[which(strand=='-' & !is.na(s))], 44001:1])
    plus2 = rbind(rep2_plus_matrix_3prime[s[which(strand=='+' & !is.na(s))], ],
                  rep2_minus_matrix_3prime[s[which(strand=='-' & !is.na(s))], 44001:1])
    plus = plus1 + plus2 / 2
    mean_list = lapply(seq(1,43801,400), function(x){
                           c(x+100, sum(plus[,x:(x+400)])/length(s)/400)
                       })
