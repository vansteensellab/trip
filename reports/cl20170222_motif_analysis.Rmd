...
## pioneer index values and subsequent values from Sherwood et al. 2014 Nat. Biotech
...
evsr_jaspar_sig = evsr_jaspar[which(evsr_jaspar$p_adjust < 0.05 &
                                    (evsr_jaspar$mean_fc < 0.5 |
                                     evsr_jaspar$mean_fc > 2)), ]
...
pdf('evsr_plots_matched.pdf')

ggplot(evsr_jaspar_m[evsr_jaspar_m$p_adjust<0.05, ], aes(x=log(mean_fc), y=tissues_expressed)) +
  geom_point(size=0.5, alpha=0.5) + 
  ggtitle('escaper vs repressed\np.adjusted < 0.05')

ggplot(evsr_jaspar_m[which(evsr_jaspar_m$p_adjust<0.05 & !is.na(evsr_jaspar_m$tissues_expressed)), ],
       aes(x=direction, color=direction, y=tissues_expressed)) + 
  geom_violin() + 
  geom_point(position=position_jitter(width=0.6), size=0.3,alpha=0.5) + 
  scale_color_manual(values=COL)

ggplot(evsr_jaspar_m[evsr_jaspar_m$p_adjust<0.05, ], aes(x=log(mean_fc), y=expression)) +
  geom_point(size=0.5, alpha=0.5) + 
  ggtitle('escaper vs repressed\np.adjusted < 0.05')

ggplot(evsr_jaspar_m[which(evsr_jaspar_m$p_adjust<0.05 & !is.na(evsr_jaspar_m$expression)), ],
       aes(x=direction, color=direction, y=expression)) + 
  geom_violin() + 
  geom_point(position=position_jitter(width=0.6), size=0.3,alpha=0.5) + 
  scale_color_manual(values=COL)

ggplot(evsr_jaspar_m[which(evsr_jaspar_m$p_adjust<0.05), ], aes(x=log(mean_fc), y=K562_opening_index)) +
  geom_point(size=0.5, alpha=0.5) + 
  ggtitle('escaper vs repressed\np.adjusted < 0.05')

ggplot(evsr_jaspar_m[which(evsr_jaspar_m$p_adjust<0.05), ],
       aes(x=direction, color=direction, y=K562_opening_index)) + 
  geom_violin() + 
  geom_point(position=position_jitter(width=0.6), size=0.3,alpha=0.5) + 
  scale_color_manual(values=COL)

ggplot(evsr_jaspar_m[which(evsr_jaspar_m$p_adjust<0.05), ], aes(x=log(mean_fc), y=opening_index)) +
  geom_point(size=0.5, alpha=0.5) + 
  ggtitle('escaper vs repressed\np.adjusted < 0.05')

ggplot(evsr_jaspar_m[which(evsr_jaspar_m$p_adjust<0.05), ],
       aes(x=direction, color=direction, y=opening_index)) + 
  geom_violin() + 
  geom_point(position=position_jitter(width=0.6), size=0.3,alpha=0.5) + 
  scale_color_manual(values=COL)


ggplot(evsr_jaspar_m[which(evsr_jaspar_m$p_adjust<0.05), ], aes(x=log(mean_fc), y=pioneer_index)) +
  geom_point(size=0.5, alpha=0.5) + 
  ggtitle('escaper vs repressed\np.adjusted < 0.05')

ggplot(evsr_jaspar_m[which(evsr_jaspar_m$p_adjust<0.05), ],
       aes(x=direction, color=direction, y=pioneer_index)) + 
  geom_violin() + 
  geom_point(position=position_jitter(width=0.6), size=0.3,alpha=0.5) + 
  scale_color_manual(values=COL)


ggplot(evsr_jaspar_m[which(evsr_jaspar_m$p_adjust<0.05), ], aes(x=log(mean_fc), y=social_index)) +
  geom_point(size=0.5, alpha=0.5) + 
  ggtitle('escaper vs repressed\np.adjusted < 0.05')

ggplot(evsr_jaspar_m[which(evsr_jaspar_m$p_adjust<0.05), ],
       aes(x=direction, color=direction, y=social_index)) + 
  geom_violin() + 
  geom_point(position=position_jitter(width=0.6), size=0.3,alpha=0.5) + 
  scale_color_manual(values=COL)
###
ggplot(evsr_jaspar_m[evsr_jaspar_m$direction!='unchanged', ], aes(x=log(mean_fc), y=tissues_expressed)) +
  geom_point(size=0.5, alpha=0.5) + 
  ggtitle('escaper vs repressed\np.adjusted < 0.05')

ggplot(evsr_jaspar_m[which(evsr_jaspar_m$direction!='unchanged' & !is.na(evsr_jaspar_m$tissues_expressed)), ],
       aes(x=direction, color=direction, y=tissues_expressed)) + 
  geom_violin() + 
  geom_point(position=position_jitter(width=0.6), size=0.3,alpha=0.5) + 
  scale_color_manual(values=COL)

ggplot(evsr_jaspar_m[evsr_jaspar_m$direction!='unchanged', ], aes(x=log(mean_fc), y=expression)) +
  geom_point(size=0.5, alpha=0.5) + 
  ggtitle('escaper vs repressed\np.adjusted < 0.05')

ggplot(evsr_jaspar_m[which(evsr_jaspar_m$direction!='unchanged' & !is.na(evsr_jaspar_m$expression)), ],
       aes(x=direction, color=direction, y=expression)) + 
  geom_violin() + 
  geom_point(position=position_jitter(width=0.6), size=0.3,alpha=0.5) + 
  scale_color_manual(values=COL)

ggplot(evsr_jaspar_m[which(evsr_jaspar_m$direction!='unchanged'), ], aes(x=log(mean_fc), y=K562_opening_index)) +
  geom_point(size=0.5, alpha=0.5) + 
  ggtitle('escaper vs repressed\np.adjusted < 0.05')

ggplot(evsr_jaspar_m[which(evsr_jaspar_m$direction!='unchanged'), ],
       aes(x=direction, color=direction, y=K562_opening_index)) + 
  geom_violin() + 
  geom_point(position=position_jitter(width=0.6), size=0.3,alpha=0.5) + 
  scale_color_manual(values=COL)

ggplot(evsr_jaspar_m[which(evsr_jaspar_m$direction!='unchanged'), ], aes(x=log(mean_fc), y=opening_index)) +
  geom_point(size=0.5, alpha=0.5) + 
  ggtitle('escaper vs repressed\np.adjusted < 0.05')
...
ggplot(evsr_jaspar_m[which(evsr_jaspar_m$direction!='unchanged'), ], aes(x=log(mean_fc), y=pioneer_index)) +
  geom_point(size=0.5, alpha=0.5) + 
  ggtitle('escaper vs repressed\np.adjusted < 0.05')
...
ggplot(evsr_jaspar_m[which(evsr_jaspar_m$direction!='unchanged'), ], aes(x=log(mean_fc), y=social_index)) +
  geom_point(size=0.5, alpha=0.5) + 
  ggtitle('escaper vs repressed\np.adjusted < 0.05')
...
ggplot(evsr_jaspar_m, aes(x=log(mean_fc), y=K562_opening_index)) +
  geom_point(size=0.5, alpha=0.5) + 
  ggtitle('escaper vs repressed\np.adjusted < 0.05')

ggplot(evsr_jaspar_m,
       aes(x=direction, color=direction, y=K562_opening_index)) + 
  geom_violin() + 
  geom_point(position=position_jitter(width=0.6), size=0.3,alpha=0.5) + 
  scale_color_manual(values=COL)

ggplot(evsr_jaspar_m, aes(x=log(mean_fc), y=opening_index)) +
  geom_point(size=0.5, alpha=0.5) + 
  ggtitle('escaper vs repressed\np.adjusted < 0.05')
...
ggplot(evsr_jaspar_m, aes(x=log(mean_fc), y=pioneer_index)) +
  geom_point(size=0.5, alpha=0.5) + 
  ggtitle('escaper vs repressed\np.adjusted < 0.05')
...
ggplot(evsr_jaspar_m, aes(x=log(mean_fc), y=social_index)) +
  geom_point(size=0.5, alpha=0.5) + 
  ggtitle('escaper vs repressed\np.adjusted < 0.05')
...
ggplot(evsilad_jaspar_m[which(evsilad_jaspar_m$direction!='unchanged' & !is.na(evsilad_jaspar_m$tissues_expressed)), ],
       aes(x=direction, color=direction, y=tissues_expressed)) + 
  geom_violin() + 
  geom_point(position=position_jitter(width=0.6), size=0.3,alpha=0.5) + 
  scale_color_manual(values=COL_class)
ggplot(evsilad_jaspar_m[evsilad_jaspar_m$direction!='unchanged', ], aes(x=log(mean_fc), y=expression)) +
  geom_point(size=0.5, alpha=0.5) + 
  ggtitle('escaper vs iLAD\np.adjusted < 0.05')

ggplot(evsilad_jaspar_m[which(evsilad_jaspar_m$direction!='unchanged' & !is.na(evsilad_jaspar_m$expression)), ],
       aes(x=direction, color=direction, y=expression)) + 
  geom_violin() + 
  geom_point(position=position_jitter(width=0.6), size=0.3,alpha=0.5) + 
  scale_color_manual(values=COL_class)
...
ggplot(evsilad_jaspar_m[which(evsilad_jaspar_m$direction!='unchanged'), ], aes(x=log(mean_fc), y=K562_opening_index)) +
  geom_point(size=0.5, alpha=0.5) + 
  ggtitle('escaper vs iLAD\np.adjusted < 0.05')

ggplot(evsilad_jaspar_m[which(evsilad_jaspar_m$direction!='unchanged'), ],
       aes(x=direction, color=direction, y=K562_opening_index)) + 
  geom_violin() + 
  geom_point(position=position_jitter(width=0.6), size=0.3,alpha=0.5) + 
  scale_color_manual(values=COL)

ggplot(evsilad_jaspar_m[which(evsilad_jaspar_m$direction!='unchanged'), ], aes(x=log(mean_fc), y=opening_index)) +
  geom_point(size=0.5, alpha=0.5) + 
  ggtitle('escaper vs iLAD\np.adjusted < 0.05')
...
ggplot(evsilad_jaspar_m[which(evsilad_jaspar_m$direction!='unchanged'), ], aes(x=log(mean_fc), y=pioneer_index)) +
  geom_point(size=0.5, alpha=0.5) + 
  ggtitle('escaper vs iLAD\np.adjusted < 0.05')
...
ggplot(evsilad_jaspar_m[which(evsilad_jaspar_m$direction!='unchanged'), ], aes(x=log(mean_fc), y=social_index)) +
  geom_point(size=0.5, alpha=0.5) + 
  ggtitle('escaper vs iLAD\np.adjusted < 0.05')
...
ggplot(evsilad_jaspar_m, aes(x=log(mean_fc), y=K562_opening_index)) +
  geom_point(size=0.5, alpha=0.5) + 
  ggtitle('escaper vs iLAD\np.adjusted < 0.05')

ggplot(evsilad_jaspar_m,
       aes(x=direction, color=direction, y=K562_opening_index)) + 
  geom_violin() + 
  geom_point(position=position_jitter(width=0.6), size=0.3,alpha=0.5) + 
  scale_color_manual(values=COL)

ggplot(evsilad_jaspar_m, aes(x=log(mean_fc), y=opening_index)) +
  geom_point(size=0.5, alpha=0.5) + 
  ggtitle('escaper vs iLAD\np.adjusted < 0.05')
...
ggplot(evsilad_jaspar_m, aes(x=log(mean_fc), y=pioneer_index)) +
  geom_point(size=0.5, alpha=0.5) + 
  ggtitle('escaper vs iLAD\np.adjusted < 0.05')
...
ggplot(evsilad_jaspar_m, aes(x=log(mean_fc), y=social_index)) +
  geom_point(size=0.5, alpha=0.5) + 
  ggtitle('escaper vs iLAD\np.adjusted < 0.05')
...
ggplot(evsilad_jaspar_m[evsilad_jaspar_m$p_adjust<0.05, ], aes(x=log(mean_fc), y=tissues_expressed)) +
  geom_point(size=0.5, alpha=0.5) + 
  ggtitle('escaper vs iLAD\np.adjusted < 0.05')

ggplot(evsilad_jaspar_m[which(evsilad_jaspar_m$p_adjust<0.05 & !is.na(evsilad_jaspar_m$tissues_expressed)), ],
       aes(x=direction, color=direction, y=tissues_expressed)) + 
  geom_violin() + 
  geom_point(position=position_jitter(width=0.6), size=0.3,alpha=0.5) + 
  scale_color_manual(values=COL)

ggplot(evsilad_jaspar_m[evsilad_jaspar_m$p_adjust<0.05, ], aes(x=log(mean_fc), y=expression)) +
  geom_point(size=0.5, alpha=0.5) + 
  ggtitle('escaper vs iLAD\np.adjusted < 0.05')

ggplot(evsilad_jaspar_m[which(evsilad_jaspar_m$p_adjust<0.05 & !is.na(evsilad_jaspar_m$expression)), ],
       aes(x=direction, color=direction, y=expression)) + 
  geom_violin() + 
  geom_point(position=position_jitter(width=0.6), size=0.3,alpha=0.5) + 
  scale_color_manual(values=COL)

ggplot(evsilad_jaspar_m[which(evsilad_jaspar_m$p_adjust<0.05), ], aes(x=log(mean_fc), y=K562_opening_index)) +
  geom_point(size=0.5, alpha=0.5) + 
  ggtitle('escaper vs iLAD\np.adjusted < 0.05')

ggplot(evsilad_jaspar_m[which(evsilad_jaspar_m$p_adjust<0.05), ],
       aes(x=direction, color=direction, y=K562_opening_index)) + 
  geom_violin() + 
  geom_point(position=position_jitter(width=0.6), size=0.3,alpha=0.5) + 
  scale_color_manual(values=COL)

ggplot(evsilad_jaspar_m[which(evsilad_jaspar_m$p_adjust<0.05), ], aes(x=log(mean_fc), y=opening_index)) +
  geom_point(size=0.5, alpha=0.5) + 
  ggtitle('escaper vs iLAD\np.adjusted < 0.05')
...
ggplot(evsilad_jaspar_m[which(evsilad_jaspar_m$p_adjust<0.05), ], aes(x=log(mean_fc), y=pioneer_index)) +
  geom_point(size=0.5, alpha=0.5) + 
  ggtitle('escaper vs iLAD\np.adjusted < 0.05')
...
ggplot(evsilad_jaspar_m[which(evsilad_jaspar_m$p_adjust<0.05), ], aes(x=log(mean_fc), y=social_index)) +
  geom_point(size=0.5, alpha=0.5) + 
  ggtitle('escaper vs iLAD\np.adjusted < 0.05')
...
pdf('evsr_plots_matched_300_300.pdf')
...
pdf('evsr_plots_matched_exp.pdf')

ggplot(evsr_jaspar_exp_m[evsr_jaspar_exp_m$p_adjust<0.05, ], aes(x=log(mean_fc), y=tissues_expressed)) +
  geom_point(size=0.5, alpha=0.5) + 
  ggtitle('escaper vs repressed\np.adjusted < 0.05')

ggplot(evsr_jaspar_exp_m[which(evsr_jaspar_exp_m$p_adjust<0.05 & !is.na(evsr_jaspar_exp_m$tissues_expressed)), ],
       aes(x=direction, color=direction, y=tissues_expressed)) + 
  geom_violin() + 
  geom_point(position=position_jitter(width=0.6), size=0.3,alpha=0.5) + 
  scale_color_manual(values=COL)

ggplot(evsr_jaspar_exp_m[evsr_jaspar_exp_m$p_adjust<0.05, ], aes(x=log(mean_fc), y=expression)) +
  geom_point(size=0.5, alpha=0.5) + 
  ggtitle('escaper vs repressed\np.adjusted < 0.05')

ggplot(evsr_jaspar_exp_m[which(evsr_jaspar_exp_m$p_adjust<0.05 & !is.na(evsr_jaspar_exp_m$expression)), ],
       aes(x=direction, color=direction, y=expression)) + 
  geom_violin() + 
  geom_point(position=position_jitter(width=0.6), size=0.3,alpha=0.5) + 
  scale_color_manual(values=COL)

ggplot(evsr_jaspar_exp_m[which(evsr_jaspar_exp_m$p_adjust<0.05), ], aes(x=log(mean_fc), y=K562_opening_index)) +
  geom_point(size=0.5, alpha=0.5) + 
  ggtitle('escaper vs repressed\np.adjusted < 0.05')

ggplot(evsr_jaspar_exp_m[which(evsr_jaspar_exp_m$p_adjust<0.05), ],
       aes(x=direction, color=direction, y=K562_opening_index)) + 
  geom_violin() + 
  geom_point(position=position_jitter(width=0.6), size=0.3,alpha=0.5) + 
  scale_color_manual(values=COL)

ggplot(evsr_jaspar_exp_m[which(evsr_jaspar_exp_m$p_adjust<0.05), ], aes(x=log(mean_fc), y=opening_index)) +
  geom_point(size=0.5, alpha=0.5) + 
  ggtitle('escaper vs repressed\np.adjusted < 0.05')
...
ggplot(evsr_jaspar_exp_m[which(evsr_jaspar_exp_m$p_adjust<0.05), ], aes(x=log(mean_fc), y=pioneer_index)) +
  geom_point(size=0.5, alpha=0.5) + 
  ggtitle('escaper vs repressed\np.adjusted < 0.05')
...
ggplot(evsr_jaspar_exp_m[which(evsr_jaspar_exp_m$p_adjust<0.05), ], aes(x=log(mean_fc), y=social_index)) +
  geom_point(size=0.5, alpha=0.5) + 
  ggtitle('escaper vs repressed\np.adjusted < 0.05')
...
ggplot(evsr_jaspar_exp_m[which(evsr_jaspar_exp_m$p_adjust<0.05), ],
  ...
  scale_color_manual(values=COL)
###
ggplot(evsr_jaspar_exp_m[evsr_jaspar_exp_m$direction!='unchanged', ], aes(x=log(mean_fc), y=tissues_expressed)) +
  geom_point(size=0.5, alpha=0.5) + 
  ggtitle('escaper vs repressed\np.adjusted < 0.05')

ggplot(evsr_jaspar_exp_m[which(evsr_jaspar_exp_m$direction!='unchanged' & !is.na(evsr_jaspar_exp_m$tissues_expressed)), ],
       aes(x=direction, color=direction, y=tissues_expressed)) + 
  geom_violin() + 
  geom_point(position=position_jitter(width=0.6), size=0.3,alpha=0.5) + 
  scale_color_manual(values=COL)

ggplot(evsr_jaspar_exp_m[evsr_jaspar_exp_m$direction!='unchanged', ], aes(x=log(mean_fc), y=expression)) +
  geom_point(size=0.5, alpha=0.5) + 
  ggtitle('escaper vs repressed\np.adjusted < 0.05')

ggplot(evsr_jaspar_exp_m[which(evsr_jaspar_exp_m$direction!='unchanged' & !is.na(evsr_jaspar_exp_m$expression)), ],
       aes(x=direction, color=direction, y=expression)) + 
  geom_violin() + 
  geom_point(position=position_jitter(width=0.6), size=0.3,alpha=0.5) + 
  scale_color_manual(values=COL)

ggplot(evsr_jaspar_exp_m[which(evsr_jaspar_exp_m$direction!='unchanged'), ], aes(x=log(mean_fc), y=K562_opening_index)) +
  geom_point(size=0.5, alpha=0.5) + 
  ggtitle('escaper vs repressed\np.adjusted < 0.05')

ggplot(evsr_jaspar_exp_m[which(evsr_jaspar_exp_m$direction!='unchanged'), ],
       aes(x=direction, color=direction, y=K562_opening_index)) + 
  geom_violin() + 
  geom_point(position=position_jitter(width=0.6), size=0.3,alpha=0.5) + 
  scale_color_manual(values=COL)

ggplot(evsr_jaspar_exp_m[which(evsr_jaspar_exp_m$direction!='unchanged'), ], aes(x=log(mean_fc), y=opening_index)) +
  geom_point(size=0.5, alpha=0.5) + 
  ggtitle('escaper vs repressed\np.adjusted < 0.05')
...
ggplot(evsr_jaspar_exp_m[which(evsr_jaspar_exp_m$direction!='unchanged'), ], aes(x=log(mean_fc), y=pioneer_index)) +
  geom_point(size=0.5, alpha=0.5) + 
  ggtitle('escaper vs repressed\np.adjusted < 0.05')
...
ggplot(evsr_jaspar_exp_m[which(evsr_jaspar_exp_m$direction!='unchanged'), ], aes(x=log(mean_fc), y=social_index)) +
  geom_point(size=0.5, alpha=0.5) + 
  ggtitle('escaper vs repressed\np.adjusted < 0.05')
...
ggplot(evsr_jaspar_exp_m, aes(x=log(mean_fc), y=K562_opening_index)) +
  geom_point(size=0.5, alpha=0.5) + 
  ggtitle('escaper vs repressed\np.adjusted < 0.05')

ggplot(evsr_jaspar_exp_m,
       aes(x=direction, color=direction, y=K562_opening_index)) + 
  geom_violin() + 
  geom_point(position=position_jitter(width=0.6), size=0.3,alpha=0.5) + 
  scale_color_manual(values=COL)

ggplot(evsr_jaspar_exp_m, aes(x=log(mean_fc), y=opening_index)) +
  geom_point(size=0.5, alpha=0.5) + 
  ggtitle('escaper vs repressed\np.adjusted < 0.05')
...
ggplot(evsr_jaspar_exp_m, aes(x=log(mean_fc), y=pioneer_index)) +
  geom_point(size=0.5, alpha=0.5) + 
  ggtitle('escaper vs repressed\np.adjusted < 0.05')
...
ggplot(evsr_jaspar_exp_m, aes(x=log(mean_fc), y=social_index)) +
  geom_point(size=0.5, alpha=0.5) + 
  ggtitle('escaper vs repressed\np.adjusted < 0.05')
