...
fwd_file_list = list.files('../cl20171206_TRIP_K562_evsr/mapping', pattern='1.table',
                           full.names=T)
names(fwd_file_list) = gsub('.*mapping/(.*).1.table', '\\1', fwd_file_list)


rev_file_list = list.files('../cl20171206_TRIP_K562_evsr/mapping', pattern='2.table',
                           full.names=T)
...
map_info$tech_rep = 1
map_info[grep('_2', map_info$name), 'tech_rep'] = 2
...
for (prom in names(class_vec)){
    for (bio in unique(map_info$bio_rep)){
        ...
        name = name_vec[-grep('_2', name_vec)]
        rev_data = rev_table_list[name_vec]
        rep1 = rev_data[[-grep('_2', name_vec)]]
        rep2 = rev_data[[grep('_2', name_vec)]]
