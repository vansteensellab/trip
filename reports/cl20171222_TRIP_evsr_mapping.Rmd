...
stat_file_vec = list.files('../cl20180102_TRIP_K562_evsr/mapping',
...
```
for f in $(ls cl20180102_TRIP_K562_evsr/mapping/*.all.txt.gz)
do
...
cDNA_vec = list.files('../cl20180102_TRIP_K562_evsr/cDNA',
                          pattern='.normalized', full.names=T)
all_file_vec = list.files('../cl20180102_TRIP_K562_evsr/mapping',
                          pattern='all.starcode.gz', full.names=T)
parsed_file_vec = list.files('../cl20180102_TRIP_K562_evsr/mapping',
                             pattern='.starcode.count', full.names=T)
mapping_file_vec = list.files('../cl20180102_TRIP_K562_evsr/mapping',
...
for (name in names(all_list)){
    cDNA = grep(gsub('_r[12]','',name), cDNA_vec, value=T)
